...
class Traper extends TargetController {
   ...
   *  "." : toutes correspondance qui exciste
   *  "!" : toutes correspondance qui sont undefined ou null
   *  "+" : toutes correspondance qui ont handlerEvent
   *  "-" : toutes correspondance qui n'ont pas de handlerEvent
   */